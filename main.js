class Parti {
    ...
    removePartis(){
        ...
        clearTimeout(this.removeTransform());
        clearTimeout(this.initPartis());
        clearInterval(this.intervalPartis());
    }
    ...
    dft() {
        ...
        if (this.transitionCss === undefined || this.transitionCss === "" ) {
            this.transitionCss = "all linear 1s";
        };

        if (this.IntervalMove === undefined || this.IntervalMove === "") {
